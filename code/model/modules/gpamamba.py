...
class GPaMamba(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.conv2d =nn.Conv2d(in_channels=self.d_inner,out_channels=self.d_inner,kernel_size=3,padding=1,stride=1)
        
        #self.channel_attention = ChannelAttentionModule(self.d_inner)
        #self.spatial_attention = SpatialAttentionModule()
        self.gpa = GPA(self.d_inner)
...
#     models = CSMamba(  d_model=32,  # Model dimension d_model
...
#     print(input.shape)
#     output = models(input)
#     input = output.permute(0, 3, 1, 2)
#     print('CM_Mamba_input_size:',input.size())
#     print('CM_Mamba_output_size:',output.size())