...
class Backbone(nn.Module):
    def __init__(self, base_dim=32):
        ...
        #level1
        self.down_level1_block1 = FGDiBlock(default_conv, base_dim, 3)
        self.down_level1_block2 = FGDiBlock(default_conv, base_dim, 3)
        self.down_level1_block3 = FGDiBlock(default_conv, base_dim, 3)
        self.down_level1_block4 = FGDiBlock(default_conv, base_dim, 3)
        self.up_level1_block1 = FGDiBlock(default_conv, base_dim, 3)
        self.up_level1_block2 = FGDiBlock(default_conv, base_dim, 3)
        self.up_level1_block3 = FGDiBlock(default_conv, base_dim, 3)
        self.up_level1_block4 = FGDiBlock(default_conv, base_dim, 3)
        
        #level2
        self.fe_level_2 = nn.Conv2d(in_channels=base_dim * 2, out_channels=base_dim * 2, kernel_size=3, stride=1, padding=1)
        self.down_level2_block1 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.down_level2_block2 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.down_level2_block3 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.down_level2_block4 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block1 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block2 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block3 = FGDiBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block4 = FGDiBlock(default_conv, base_dim * 2, 3)

        #level3
        self.fe_level_3 = nn.Conv2d(in_channels=base_dim * 4, out_channels=base_dim * 4, kernel_size=3, stride=1, padding=1)
        self.level3_block1 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block2 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block3 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block4 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block5 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block6 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block7 = FGDiMBlock(default_conv, base_dim * 4, 3)
        self.level3_block8 = FGDiMBlock(default_conv, base_dim * 4, 3)
